...
export const ItemTodo = ({priority, title, onClickDelete, onClickEdit, onChangeChecklist, data}: IItemTodo) => {
    ...
    <Card className={"py-[26px] px-[28px] flex items-center justify-between shadow-md"}>
      <div className={"flex items-center gap-6"}>
        ...
        <div className={"flex gap-2 items-center"}>
          ...
          <span className={`${data.is_active === 0 && "line-through text-gray-500"}`}> {title}</span>
